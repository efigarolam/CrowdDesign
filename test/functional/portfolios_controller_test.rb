...
class PortfoliosControllerTest < ActionController::TestCase
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post :create, portfolio: { description: @portfolio.description, release_date: @portfolio.release_date, title: @portfolio.title }
    end
  ...
  test "should update portfolio" do
    put :update, id: @portfolio, portfolio: { description: @portfolio.description, release_date: @portfolio.release_date, title: @portfolio.title }
    assert_redirected_to portfolio_path(assigns(:portfolio))
  end
